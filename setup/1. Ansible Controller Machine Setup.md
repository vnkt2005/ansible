...
4. ```sh
   ...
   ```
5. After saving the vagrantfile, validate the syntax with the following command. Alternatively you can use "http://codebeautify.org/ruby-formatter-beautifier/". Or from google search for "vagrant file generator".
6. ```sh
   vagrant validate
   ```
